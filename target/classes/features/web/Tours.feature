...
Feature: As a User on  Sydeny opera House i want to book Tours
  ...
  -Verify that user able to add ticket insurance  to ticket value 
  ...
  Scenario Outline: Verify that user able to  add a tour and book tours as member user
    ...
    Examples: 
      | Month and Year | date | username            | password | cardHoldername | cardnumber        | date    | CVV |
      | AUGUST 2016    |   29 | gmalik4@sapient.com | secret11 | Jørn Utzon     | 41111111111111111 | 03/2020 | 123 |
